...
public class BaeMoLoginFilter extends UsernamePasswordAuthenticationFilter {
    private static final ObjectMapper OBJECT_MAPPER = new ObjectMapper();
    private final AuthenticationManager authenticationManager;
    private final JwtUtil jwtUtil;

    public BaeMoLoginFilter(AuthenticationManager authenticationManager, JwtUtil jwtUtil, String loginUrl) {
    ...
    public Authentication attemptAuthentication(HttpServletRequest request, HttpServletResponse response) throws AuthenticationException {
        try {
            ...
            final var requestDTO = OBJECT_MAPPER.readValue(inputStream, JwtLoginDTO.BaeMoLogin.class);

            final var token = new BaeMoAuthenticationToken(null, requestDTO.password(), requestDTO.phone());
