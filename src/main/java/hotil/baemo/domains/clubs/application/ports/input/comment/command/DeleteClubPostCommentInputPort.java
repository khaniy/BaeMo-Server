...
import hotil.baemo.domains.clubs.domain.policy.comment.DeleteClubPostCommentPolicy;
...
public class DeleteClubPostCommentInputPort implements DeleteClubPostCommentUseCase {
    ...
    @Override
    public void delete(ClubPostCommentId clubPostCommentId, UserId userId) {
        DeleteClubPostCommentPolicy.execute(clubPostCommentId, userId)
            .valid(queryClubPostCommentOutputPort::load)
            .delete(commandClubPostCommentOutPort::delete);
    }
}