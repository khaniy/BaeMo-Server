...
public class UpdateThumbnailExercisePolicy {

    private final UserId userId;
    private final ExerciseId exerciseId;


    public static UpdateThumbnailExercisePolicy execute(UserId userId, ExerciseId exerciseId) {
        return new UpdateThumbnailExercisePolicy(userId, exerciseId);
    }
    ...
    public static class ExecuteStep {
        ...
        public PersistStep updateThumbnail(ExerciseThumbnail thumbnail) {
            return PersistStep.of(exercise, thumbnail);
        }
    }
    ...
    public static class PersistStep {
        ...
        private final Exercise exercise;
        private final ExerciseThumbnail thumbnail;

        public void persist(final BiConsumer<Exercise, ExerciseThumbnail> repository) {
            repository.accept(exercise, thumbnail);
