...
public class ExpelExerciseMemberPolicy {

    private final UserId userId;
    private final ExerciseId exerciseId;


    public static ExpelExerciseMemberPolicy execute(UserId userId, ExerciseId exerciseId) {
        return new ExpelExerciseMemberPolicy(userId, exerciseId);
    }
    ...
    public static class ExecuteStep {
        ...
        public PersistStep expelMember(UserId memberId) {
            ...
            if (exercise instanceof ClubExercise clubExercise) {
                exerciseUser = clubExercise.expelMember(memberId);
            } else {
                exerciseUser = exercise.expelMember(memberId);
            }
