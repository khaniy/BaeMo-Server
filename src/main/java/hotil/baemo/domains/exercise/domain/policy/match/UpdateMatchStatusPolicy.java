...
public class UpdateMatchStatusPolicy {
    ...
    public static class ExecuteStep {
        ...
        public PersistStep updateStatus(MatchStatus matchStatus, CourtNumber courtNumber) {
            match.updateMatch(matchStatus, courtNumber, courts);
