...
public class RejectPendingUserPolicy {

    private final UserId userId;
    private final ExerciseId exerciseId;


    public static RejectPendingUserPolicy execute(UserId userId, ExerciseId exerciseId) {
        return new RejectPendingUserPolicy(userId, exerciseId);
    }
    ...
    public static class PersistStep {
        ...
        public void persist(
            final Consumer<ExerciseUser> repository1) {
