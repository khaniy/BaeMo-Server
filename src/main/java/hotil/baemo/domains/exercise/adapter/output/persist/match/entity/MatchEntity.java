package hotil.baemo.domains.exercise.adapter.output.persist.match.entity;

import hotil.baemo.core.common.persistence.BaeMoBaseEntity;
import hotil.baemo.domains.exercise.adapter.output.persist.match.entity.converter.TeamLogConverter;
import hotil.baemo.domains.exercise.adapter.output.persist.match.entity.converter.UserLogConverter;
