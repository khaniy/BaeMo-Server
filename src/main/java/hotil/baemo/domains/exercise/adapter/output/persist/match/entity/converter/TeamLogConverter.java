package hotil.baemo.domains.exercise.adapter.output.persist.match.entity.converter;
...
@Converter
public class TeamLogConverter implements AttributeConverter<List<Team>, String> {
