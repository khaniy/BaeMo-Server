package hotil.baemo.domains.exercise.adapter.output.event.sse;

import hotil.baemo.core.common.response.ResponseCode;
import hotil.baemo.core.common.response.exception.CustomException;
import hotil.baemo.core.event.ScoreBoardTopic;
import hotil.baemo.core.util.BaeMoObjectUtil;
import hotil.baemo.domains.exercise.adapter.output.event.sse.repository.ScoreBoardSseLocalRepository;
...
//        emitters.forEach(SseEmitter::complete);
    ...
    public void sendMessage(ScoreBoardTopic.ScoreUpdatedEvent dto) {
