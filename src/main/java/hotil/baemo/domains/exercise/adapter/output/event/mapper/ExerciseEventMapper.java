...
public class ExerciseEventMapper {
    ...
    public static ExerciseEventDTO.Created toCreatedDTO(Exercise exercise, UserId userId) {
    ...
    public static ExerciseEventDTO.UserApplied toUserApplied(Exercise exercise, ExerciseUser targetUser) {
    ...
    public static ExerciseEventDTO.UserCancelled toUserCancelled(Exercise exercise, boolean bySelf, ExerciseUser targetUser) {
    ...
    public static ExerciseEventDTO.UserRoleChanged toUserRoleChanged(Exercise exercise, ExerciseUser targetUser) {
