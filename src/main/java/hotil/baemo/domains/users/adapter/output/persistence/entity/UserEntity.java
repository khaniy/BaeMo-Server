...
public abstract class UserEntity extends BaeMoBaseEntity implements BaeMoUserDetails {
    @Id
    ...
    public UserEntity(Long id, JoinType joinType, String phone, String baemoCode, String nickname, String realName, Level level, String description, LocalDate birth, Gender gender, String profileImage, Boolean isDel, Boolean requiredTerms) {
        this.id = id;
